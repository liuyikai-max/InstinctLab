...
MOTION_NAME = "X2SheMen"
_hacked_selected_file_ = "x2shemen_pkl_256602ab_x2t2d5_instinct_retargetted.npz"
...
class AmassMotionCfg(AmassMotionCfgBase):
    ...
    path = os.path.expanduser("~/projects/bm_for_x2t2d5/motions_npz")
...
@configclass
class X2T2D5BeyondMimicPlaneEnvCfg(beyondmimic_cfg.BeyondMimicEnvCfg):
    """X2T2D5 BeyondMimic plane environment configuration."""
    ...
    def __post_init__(self):
        ...
        # self.rewards.rewards.undesired_contacts.params["sensor_cfg"].body_names = [
        #     r"^(?!left_ankle_roll_link$)(?!right_ankle_roll_link$)(?!left_wrist_roll_link$)(?!right_wrist_roll_link$).+$"
        # ]
        # self.terminations.link_pos_too_far.params["reference_cfg"].body_names = [
        #     "left_ankle_roll_link", "right_ankle_roll_link", "left_wrist_roll_link", "right_wrist_roll_link"
        # ]
        # self.events.base_com.params["asset_cfg"].body_name = "base_link"
...
@configclass
class X2T2D5BeyondMimicPlaneEnvCfg_PLAY(X2T2D5BeyondMimicPlaneEnvCfg):
    """X2T2D5 BeyondMimic plane environment configuration for playing/evaluation."""

    scene: beyondmimic_cfg.BeyondMimicSceneCfg = beyondmimic_cfg.BeyondMimicSceneCfg(
        num_envs=1,
        env_spacing=2.5,
        robot=X2T2D5_CYLINDER_CFG.replace(prim_path="{ENV_REGEX_NS}/Robot"),
        robot_reference=X2T2D5_CYLINDER_CFG.replace(prim_path="{ENV_REGEX_NS}/RobotReference"),
