...
class AlgorithmCfg(InstinctRlPpoAlgorithmCfg):
    ...
    teacher_logdir = os.path.expanduser(
        "~/Data/instinctlab_logs/instinct_rl/x2t2d5_perceptive_shadowing/20260111_103654_x2t2d5Perceptive_4MotionsKneelClimbStep1_concatMotionBins__GPU0_from20260108_032900"
    )
...
@configclass
class X2T2D5PerceptiveVaePPORunnerCfg(InstinctRlOnPolicyRunnerCfg):
    ...
    save_interval = 1000
    log_interval = 10
    experiment_name = "x2t2d5_perceptive_vae"
